...
export default function AttendanceTab({ tuitionId }) {
  ...
  const canWrite      = () => ['manager', 'coordinator'].includes(user?.role)
  ...
  return (
    <div className="border border-slate-200 rounded-xl overflow-hidden bg-white">
      ...
      {rows.map((a, i) => {
        ...
        const durMismatch = !a.isDemo && classDur && String(a.dur) !== classDur
        ...
        return (
          <div key={a.id} className="grid border-b border-slate-100 items-center"
            ...
            <div className="px-3 py-2.5 flex items-center gap-1">
              ...
              {durMismatch && <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#D97706" strokeWidth="2.2" strokeLinecap="round"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>}
            </div>
